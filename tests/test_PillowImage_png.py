...
class TestPillowImagePNG(unittest.TestCase):
    ...
    def test_draw_text(self):
        ...
        d = self.draw.save(destination=os.path.join(TEST_RESULTS_DIR, 'png'), file_name='draw_text')
    ...
    def test_draw_img(self):
        ...
        d = self.draw.save(destination=os.path.join(TEST_RESULTS_DIR, 'png'), file_name='draw_img')
    ...
    def test_draw_img_overlay(self):
        ...
        self.draw.draw_img(self.wtrmrk_path, opacity=0.08, rotate=30)
        d = self.draw.save(destination=os.path.join(TEST_RESULTS_DIR, 'png'), file_name='draw_img_overlay')
    ...
    def test_draw_img_centered(self):
        ...
        d = self.draw.save(destination=os.path.join(TEST_RESULTS_DIR, 'png'), file_name='draw_img_centered')
    ...
    def test_draw_img_negbound(self):
        ...
        d = self.draw.save(destination=os.path.join(TEST_RESULTS_DIR, 'png'), file_name='draw_img_negbound')
    ...
    def test_draw_img_percentage(self):
        ...
        d = self.draw.save(destination=os.path.join(TEST_RESULTS_DIR, 'png'), file_name='draw_img_percentage')
    ...
    def test_draw_img_resized(self):
        ...
        d = self.draw.save(destination=os.path.join(TEST_RESULTS_DIR, 'png'), file_name='draw_img_resized')
    ...
    def test_draw_img_resize_width(self):
        ...
        d = self.draw.save(destination=os.path.join(TEST_RESULTS_DIR, 'png'), file_name='draw_img_resized_width')
    ...
    def test_draw_img_resize_height(self):
        ...
        d = self.draw.save(destination=os.path.join(TEST_RESULTS_DIR, 'png'), file_name='draw_img_resized_height')
    ...
    def test_rotate(self):
        ...
        self.draw.draw_img(self.img_path)
        self.draw.rotate(30)
        d = self.draw.save(destination=os.path.join(TEST_RESULTS_DIR, 'png'), file_name='rotate')
    ...
    def test_size(self):
        ...
        self.draw = PillowImage(img=self.img_path)
        size = self.draw.size
        d = self.draw.save(destination=os.path.join(TEST_RESULTS_DIR, 'png'), file_name='size')
    ...
    def test_width(self):
        ...
        d = self.draw.save(destination=os.path.join(TEST_RESULTS_DIR, 'png'), file_name='width')
    ...
    def test_height(self):
        ...
        d = self.draw.save(destination=os.path.join(TEST_RESULTS_DIR, 'png'), file_name='height')
